...
public class Client extends AppCompatActivity implements View.OnDragListener{
    ...
    private ClientBinding mainActivityBindin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivityBindin = DataBindingUtil.setContentView(this, R.layout.activity_client);
        ...
        mainActivityBindin.setClient(this);
        ...
        backofcard.setOnClickListener(view -> {
            ...
            if (turn) {
                reference.child("remaining").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        ...
                        if (remainingcards.size() > 0) {
                            ...
                            int r = new Random().nextInt(remainingcards.size());
                            Query query = reference.child("player2");
                            query.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (last == 13) {
                                        reference.child("player2").child(String.valueOf(last)).setValue(remainingcards.get(r));
                ...
                Toast.makeText(Client.this,"It's not your turn",Toast.LENGTH_SHORT).show();
            }
        });
        allopencards.setOnClickListener(view -> {
            if (opencardlist.size()>0){
                ...
                reference.child("opencard").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            if (openc.size() > 0){
                                ...
                                GridLayoutManager mlayout = new GridLayoutManager(Client.this, 3, GridLayoutManager.VERTICAL, true);
                    ...
                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(Client.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Client.this,"No open cards!",Toast.LENGTH_LONG).show();
            }
    ...
    private void removeopen(int pos) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapsho) {
                ...
                Query query = reference.child("player2").orderByKey().limitToLast(1);
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                            ...
                            reference.child("player2").child(String.valueOf(last)).setValue(Objects.requireNonNull(dataSnapsho.getValue()).toString()).addOnCompleteListener(task -> dataSnapsho.getRef().removeValue());
                        }
                    }
    ...
    private void addopen() {
        ...
        if (sum == 14||fsum==1) {
            ...
            reference.child("player2").child(String.valueOf(handcardToMove.position)).removeValue();
            rearrangedata();
            switch (Integer.parseInt(idd)) {
                case 0:
                    handcardList.remove(handcardToMove);
        ...
        reference.child("player2").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    reference.child("player2").setValue(rearrangecards);
                }
            }
    ...
    private void load() {
        ...
        reference.child("player2").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
    ...
    private void removeextra() {
        reference.child("player2").child("13").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                        ...
                        reference.child("player2/13").setValue(null);
